    ...
    <>
      ...
      {tool === "eraser" && option && (
        <div className="items-center md:p-0 md:px-3 block absolute bg-white right-12 top-32 text-black md:flex md:static rounded-lg p-4">
          ...
          <div className="border-black border-solid border-l-2 mx-2 w-1 h-6 invisible md:visible"></div>
          <button
            className={`flex justify-center items-center p-1 border-2 border-transparent  ${properties.mode == "remover"
      ...
      {tool === "text" && option && (
        <div className="items-center md:p-0 md:px-3 block absolute bg-white right-12 top-32 text-black md:flex md:static rounded-lg p-4">
          ...
          <div className="border-black border-solid border-l-2 mx-2 w-1 h-6 invisible md:visible"></div>
          <button
            className={`mx-1 text-lg font-bold border-black px-2 text-center  ${"fontWeight" in properties && properties.fontWeight === "700"
          ...
          <button
            className={`mx-1 text-lg italic border-black px-2 text-center  ${"style" in properties && properties.style === "italic"
              ? "border-t-2 border-l-2"
              : "border-r-2 border-b-2"
              }`}
            onClick={textItalic}
          ...
          <button
            className={`mx-1 text-lg underline border-black px-2 text-center  ${"underline" in properties && properties.underline === true
              ? "border-t-2 border-l-2"
              : "border-r-2 border-b-2"
              }`}
            onClick={underline}
          ...
          <div className="border-black border-solid border-l-2 mx-2 w-1 h-6 invisible md:visible"></div>
          <button
            className={`mx-1 text-lg font-bold border-black px-2 text-center  ${properties.align === "left"
              ? "border-t-2 border-l-2 "
              : "border-r-2 border-b-2"
              }`}
          ...
          <button
            className={`mx-1 text-lg italic border-black px-2 text-center  ${properties.align === "center"
              ? "border-t-2 border-l-2"
              : "border-r-2 border-b-2"
              }`}
          ...
          <button
            className={`mx-1 text-lg underline border-black px-2 text-center  ${properties.align === "right"
              ? "border-t-2 border-l-2"
              : "border-r-2 border-b-2"
              }`}
      ...
      {tool === "shape" && option && (
        <div className="items-center md:p-0 md:px-3 block absolute bg-white right-12 top-32 text-black md:flex md:static rounded-lg p-4">
          ...
          <div className="border-black border-solid border-l-2 mx-2 w-1 h-6 invisible md:visible"></div>
          <button
            className={`mx-1 text-lg font-bold border-black px-2 text-center  ${properties.shape === "rect"
              ? "border-t-2 border-l-2 "
              : "border-r-2 border-b-2"
              }`}
            onClick={() => shape("rect")}
          ...
          <button
            className={`mx-1 text-lg font-bold border-black px-2 text-center  ${properties.shape === "circle"
              ? "border-t-2 border-l-2 "
              : "border-r-2 border-b-2"
              }`}
          ...
          <button
            className={`mx-1 text-lg font-bold border-black px-2 text-center  ${properties.shape === "triangle"
              ? "border-t-2 border-l-2 "
              : "border-r-2 border-b-2"
              }`}
          ...
          <button
            className={`mx-1 text-lg font-bold border-black px-2 text-center  ${properties.shape === "ellipse"
              ? "border-t-2 border-l-2 "
              : "border-r-2 border-b-2"
              }`}
          ...
          <button
            className={`mx-1 text-lg font-bold border-black px-2 text-center  ${properties.shape === "line"
              ? "border-t-2 border-l-2 "
              : "border-r-2 border-b-2"
              }`}
            onClick={() => shape("line")}
