...
import { changeColor } from "../../lib/stores/ToolStore.js";
import { CanvasBackground } from "../../lib/stores/CanvasStore.js";
...
const ColorButton = ({ color, name, type }) => {
  ...
  return (
    <button
      className={`${color} flex h-4 w-4 mx-2 ${color_slice === name && type !== "bg" ? "border-black border-2" : ""
