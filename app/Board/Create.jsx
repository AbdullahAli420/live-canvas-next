...
import { setCreate } from "../../lib/stores/ToolStore";
import { SetupBoard, addUser } from "../../lib/stores/CanvasStore";
        ...
        <>
          ...
          <div className="flex w-full absolute justify-center top-0 z-30">
            <div className="md:p-0 mt-2 md:px-3 block h-min top-3 bg-white text-black rounded- p-4 opacity border-solid border-[1px] border-black">
              <div className="flex">
                <button
                  className={`text-2xl m-2 hover:border-gray-400 border-b-2 ${form === "join" ? " border-black" : ""
                    }`}
                ...
                <button
                  className={`text-2xl m-2 hover:border-gray-400 border-b-2 ${form === "create" ? " border-black" : ""
                    }`}
